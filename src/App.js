...
function App() {
    ...
    return (
        <>
            ...
            {/* <input type="date" onChange={(e) => { setusdat(e.target.value) }} /> */}

            <table>
                <caption>Result</caption>
                <tr>
                    <td>Year : </td>
                    <td><input type="text" value={dispyear} /></td>
                </tr>
                <tr>
                    <td>Month : </td>
                    <td><input type="text" value={dispmonth} /></td>
                </tr>
                <tr>
                    <td>Week : </td>
                    <td><input type="text" value={dispweek} /></td>
                </tr>
                <tr>
                    <td>Days : </td>
                    <td><input type="text" value={dispdays} /></td>
                </tr>
                <tr>
                    <td>Hours : </td>
                    <td><input type="text" value={disphours} /></td>
                </tr>
                <tr>
                    <td>Minits : </td>
                    <td><input type="text" value={dispminits} /></td>
                </tr>
                <tr>
                    <td>Seconds : </td>
                    <td><input type="text" value={dispseconds} /></td>
                </tr>
                <tr>
                    <td>Miliseconds : </td>
                    <td><input type="text" value={dispmiliseconds} /></td>
                </tr>
            </table>
        </>
    );
